...
namespace LTSAPI.Parser
{
    public class AccommodationParser
    {
            ...
            IDictionary<string, JArray> jsonfiles)
        {
            ...
            if (accommodation.isSuedtirolInfoActive != null && accommodation.isSuedtirolInfoActive.Value)
            {
            ...
            if(!String.IsNullOrEmpty(accommodation.id.ToString()))
                ltsriddict.TryAddOrUpdate("a0r_id", accommodation.id.ToString());

            if (!String.IsNullOrEmpty(accommodation.representationMode))
            ...
            if (accommodation.type != null)
            {
                ...
                accommodationlinked.TagIds.Add(accommodation.type.rid);
            }

            if (accommodation.category != null)
            {
            ...
            //Board Infos        
            if (accommodation.mealPlans != null && accommodation.mealPlans.Count() > 0)
            {
                ...
                foreach (var tin in accommodation.amenities)
                {
                    ...
                    if (myfeature != null)
                    {
                        ...
                        if (myfeatureparsed != null)
                        {
                            ...
                            //if (accommodationlinked.TagIds == null)
                            //    accommodationlinked.TagIds = new List<string>();
                            //accommodationlinked.TagIds.Add(tin.rid);
                        }
                        else
                        {
                            //TODO Error Log                            
            ...
            if (accommodation.contacts != null)
            {
                ...
                //opendata fix
                if (contactinfo == null)
                    contactinfo = accommodation.contacts.FirstOrDefault();
                ...
                if (contactinfo != null)
                {
                    foreach (string lang in haslanguage)
                    {
                        ...
                        mydetail.Longdesc = accommodation.descriptions != null && accommodation.descriptions.Where(x => x.type == "longDescription").Count() > 0
                            ? accommodation.descriptions.Where(x => x.type == "longDescription").FirstOrDefault()?.description[lang] : null;
                        mydetail.Shortdesc = accommodation.descriptions != null && accommodation.descriptions.Where(x => x.type == "shortDescription").Count() > 0
                            ? accommodation.descriptions.Where(x => x.type == "shortDescription").FirstOrDefault()?.description[lang] : null;
            ...
            if (accommodation.accessibility != null)
            {
                foreach (var lang in haslanguage)
                {
                    ...
                    independentdetail.BacklinkUrl = accommodation.accessibility.website != null && accommodation.accessibility.website.ContainsKey(lang) ? accommodation.accessibility.website[lang] : null;
                    independentdetail.Description = accommodation.accessibility.description != null && accommodation.accessibility.description.ContainsKey(lang) ? accommodation.accessibility.description[lang] : null;
                    independentdetail.CommitmentToAccessibilityUrl = accommodation.accessibility.commitmentToAccessibilityUrl != null && accommodation.accessibility.commitmentToAccessibilityUrl.ContainsKey(lang) ? accommodation.accessibility.commitmentToAccessibilityUrl[lang] : null;
            ...
            IDictionary<string, JArray> jsonfiles)
        {
            ...
            if (accommodation.roomGroups != null)
            {
        ...
        private static void UpdateThemes(AccommodationV2 myacco, XDocument mywinelist, XDocument mycitylist, XDocument myskiarealist, XDocument mymediterranenlist, XDocument dolomiteslist, XDocument alpinelist)
        {
            if (myacco.Features != null)
            {
                ...
                if (myacco.TourismVereinId != null && tvtoassign.Contains(myacco.TourismVereinId.ToUpper()))
