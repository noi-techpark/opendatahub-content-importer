    ...
    public class AccommodationCategoriesParser
    {
            ...
            )
        {
            ...
            catch(Exception ex)
            {
                ...
                Console.WriteLine(JsonConvert.SerializeObject(new { operation = "accommodation.categories.parse", id = dataid, source = "lts", success = false, error = true, exception = ex.Message }));
